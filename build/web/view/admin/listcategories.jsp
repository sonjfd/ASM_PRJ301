            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-light navbar-light">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <a href="listcategories" class="nav-item nav-link active"><i class="fa fa-th me-2"></i>Quản Lí Danh Mục</a>
            ...
            <div class="content">
                ...
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item"><button class=" btn btn-primary">
                            <a href="addcategories" style="color: white">Tạo Mới Danh Mục</a>
                        </button></li>

                </ol>
                <br/>

                <form action="searchcategories" method="GET" class="d-flex align-items-center">
                    <input 
                        type="text" 
                        name="name" 
                ...
                <form action="fillter-categories" method="get">
                ...
                <table style="border: 1px solid">
                    ...
                    <c:forEach items="${requestScope.categories}" var="cate">
                        <tr>
                            ...
                            <td><img src="${pageContext.request.contextPath}${cate.avatar}" alt="alt" width="50px"/></td>

                            <td>${cate.createdAt}</td>
                            <td>${cate.updateAt}</td>
                            <td>
                                <a href="updatecategories?id=${cate.id}" class="btn btn-primary btn-sm">
                                    UPDATE <i class="bi bi-pencil-square"></i>
                                </a>


                                <form action="togglestatus" method="get" style="display:inline;">
                                    <input type="hidden" name="id" value="${cate.id}" />
                                    <input type="hidden" name="status" value="${cate.status}" />
                                    <button type="submit" class="btn ${cate.status == 1 ? 'btn-success' : 'btn-dark'} btn-sm">
                                        ${cate.status == 1 ? 'Ẩn' : 'Hiện'}
                                        <i class="bi ${cate.status == 1 ? 'bi-toggle-on' : 'bi-toggle-off'}"></i>
                                    </button>
                                </form>
                            </td>
                ...
                <div class="footer">
                    ...
                    <script>
                        function filterCategories() {
                            ...
                            let url = "fillter-categories?status=" + status;
