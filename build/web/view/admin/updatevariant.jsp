                    ...
                    <nav class="navbar bg-light navbar-light">
                        ...
                        <div class="d-flex align-items-center ms-4 mb-4">
                            <div class="position-relative">
                                <img class="rounded-circle" src="${pageContext.request.contextPath}/assets/img/user.jpg" alt="" style="width: 40px;
                                height: 40px;">
                ...
                <div class="content">
                        ...
                        <div class="navbar-nav align-items-center ms-auto">
                            ...
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                                    <img class="rounded-circle me-lg-2" src="${pageContext.request.contextPath}/assets/img/user.jpg" alt="" style="width: 40px;
                                         height: 40px;">
                    ...
                    <div class="container form-container">
                        <h1 style="color: red">${message}</h1>
                            <h2 class="text-center">Cập Nhật Biến Thể</h2>
                            <form action="updatevariant" method="post">
                                <input type="hidden" name="id" value="${variant.id}">

                                <div class="mb-3">
                                    <label for="id">ID:</label>
                                    <input type="number" class="form-control" id="id" name="id" value="${variant.id}" readonly>
                                </div>
                                <div class="mb-3">
                                    <label for="price" class="form-label">Giá:</label>
                                    <input type="text" class="form-control" name="price" value="${variant.price}" required>
                                </div>

                                <div class="mb-3">
                                    <label for="sale" class="form-label">Giảm Giá:</label>
                                    <input type="text" class="form-control" name="sale" value="${variant.sale}" required>
                                </div>

                                <div class="mb-3">
                                    <label for="stock" class="form-label">Số Lượng:</label>
                                    <input type="text" class="form-control" name="stock" value="${variant.stock}" required>
                                </div>
