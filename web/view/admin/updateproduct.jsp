                        ...
                        <h1 style="color: red">${message}</h1>
                            ...
                            <form action="updateproduct" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="content" name="content" rows="4" required>${product.content}</textarea>
                                </div>

                                <!-- Lựa chọn danh mục -->
                                <div class="mb-3">
                                    <label for="cid" class="form-label">Lựa chọn Danh Mục:</label>
                                    <select name="cid">
                                ...
                                <div class="mb-3">
                                    ...
                                    <c:if test="${not empty product.avatar}">
                                        <img src="${product.avatar}" alt="Avatar" width="100">
                                    </c:if>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="hot" name="hot" value="${product.hot}" required>
                                </div>
