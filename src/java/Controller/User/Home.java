...
import Controller.admin.ListProduct;
...
public class Home extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<ProductVariant> listv=variantdao.getTop15HotProductVariants();
        request.setAttribute("listvariant", listv);
        
        List<ProductVariant>salevariants =variantdao.getTop15SaleProductVariants();
        request.setAttribute("salevariants", salevariants);
